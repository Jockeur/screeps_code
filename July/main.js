...
module.exports.loop = function () {
    ...
    for (let spawnName in Game.spawns) {
        ...
        var dealers = _.sum(creepInRoom, (c) => c.memory.role == 'mineralLorry' && c.memory.target.id == c.room.terminal.id);
        ...
        if (harvesters < maxHarvesters) {
            ...
            spawn.spawnLongDistanceCreep(energy, newName, 5, spawn.room.name, 'E18N3', 0, 'localBuilder')
